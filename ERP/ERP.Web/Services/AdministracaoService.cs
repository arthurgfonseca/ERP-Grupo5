...
namespace ERP.Web
{
    ...
    public class AdministracaoService : LinqToEntitiesDomainService<erp_administracaoEntities>
    {
        ...
        public ConvenioServicoSet GetConvenioServicoSet_Id(int idConvernioServicoSet)
        {
            return this.ObjectContext.ConvenioServicoSet.Where(e => e.id == idConvernioServicoSet).First<ConvenioServicoSet>();
        }
